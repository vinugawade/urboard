  ...
  Swal.fire({
    ...
    <div class="px-6 pt-4 pb-2 text-center font-bold">
      ...
      <table class="w-full border-collapse text-xs font-normal mt-3">
        ...
        <tbody>
          <tr>
            <td class="h-12">Show/Hide Clipboard [<svg title="Linux Distros" class="inline" xmlns="http://www.w3.org/2000/svg" width="14" height="14"
              ...
              </svg> / <svg title="Mac OS" class="inline" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
          ...
          <tr>
            <td class="h-6">
              <svg class="inline" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 14 14">
                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                  <path
                    d="M13.207.793a1 1 0 0 1 .293.707v11a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1v-11a1 1 0 0 1 1-1h11a1 1 0 0 1 .707.293m-2.76 4.412v3.59M9.25 5.205h2.394" />
                  <path
                    d="M6.747 5.205v3.59h2.095m-6.592 0l1.102-3.307a.415.415 0 0 1 .394-.283v0c.179 0 .337.114.394.283l1.102 3.307M2.649 7.598h2.194" />
                </g>
